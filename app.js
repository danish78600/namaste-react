...
//body-search,res-card-image,name,rating etc
//footer
    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdaMYtVi9_tfNcpsbGGseU6ehYgV9UeU3h7A&s" className="logo" />
            </div>
...
const RestaurentCard = (props) => {
    ...
    return (
        <div className="res-card" style={{backgroundColor:"#f0f0f0"}}>
            <img src="https://www.shutterstock.com/image-vector/have-your-tasty-fun-emotional-600nw-2011862369.jpg" alt="res-logo" className='res-logo'/>
            <h3>{(name)}</h3>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>  
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                {
                resObj.map(restaurant => <RestaurentCard key={restaurant.data.id} resData={restaurant}/>)
                }
            </div>
        </div>
    )
